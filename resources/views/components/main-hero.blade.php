                    ...
                    <form>
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div class="grid grid-cols-2 gap-2 p-2 border border-gray-200 rounded">
                                <div class="flex items-center p-2 bg-gray-300 border rounded ">
                                    <svg class="w-5 mr-2 text-gray-800 fill-current"
                                    ...
                                    <input type="text" placeholder="Title..." name="title" id="title"
                                        class="max-w-full text-gray-700 bg-gray-300 focus:outline-none" />
                                </div>
                                <div class="flex items-center p-2 bg-gray-300 border rounded ">
                                    <svg class="w-5 mr-2 text-gray-800 fill-current"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                    ...
                                    <select class="w-full text-gray-700 bg-gray-300 focus:outline-none"
                                        id="category">
                        ...
                        <div class="flex justify-center">
                            <button type="button" id="filter"
                                class="w-1/4 p-2 m-2 text-white bg-gray-800 border rounded-md">Filter</button>
                        </div>
                    </form>
                </div>
            </div>
